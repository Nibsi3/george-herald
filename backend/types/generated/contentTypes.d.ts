...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'News articles for George Herald';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    articleImages: Schema.Attribute.Media<'images', true>;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Journalists and writers';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Journalist'>;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    parentSection: Schema.Attribute.Enumeration<
      [
        'news',
        'sport',
        'lifestyle',
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedDate: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<
      ['general', 'news', 'schools', 'special-events', 'sport']
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedDate: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<
      ['news', 'sport', 'business', 'entertainment', 'lifestyle']
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
