...
import { Menu, Search, X, ChevronDown, CloudSun, Globe } from "lucide-react";
...
export default function Header() {
  ...
  return (
    ...
    <header className="w-full bg-white">
      ...
      <div className="bg-herald-black text-white">
        <div className="container mx-auto px-4 flex items-center justify-between h-10">
          ...
          <div className="flex items-center gap-3" ref={translateRef}>
            <a href="https://www.facebook.com/georgeherald" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="Facebook">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.youtube.com/@georgeherald" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="YouTube">
            ...
            <a href="https://x.com/georgeherald" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="X (Twitter)">
              <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://www.instagram.com/georgeherald" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.tiktok.com/@georgeherald" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="TikTok">
            ...
            <div className="relative">
              ...
              {translateOpen && (
                <div className="absolute right-0 mt-2 min-w-[120px] rounded-md border border-white/10 bg-[#141414] shadow-lg overflow-hidden z-[60]">
                  {translateLanguages.map((l) => (
                    <button
                      key={l.value}
                      onClick={() => setTranslateLanguage(l.value, l.label)}
                      className="w-full px-3 py-2 text-left text-xs text-white/80 hover:text-white hover:bg-white/10 transition-colors"
                    >
                      {l.label}
                    </button>
                  ))}
    ...
    {/* ── ROW 3: Category navigation + Search (sticky on scroll) ── */}
    <nav className="hidden lg:block border-b border-border bg-white sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center h-11">
            ...
            <div className="flex items-center shrink-0" ref={searchRef}>
              {searchOpen ? (
                <div className="relative">
                  <form
